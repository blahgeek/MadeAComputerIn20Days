...
# ghdl --gen-makefile TLBTestbench

GHDL=ghdl
GHDLFLAGS=
GHDLRUNFLAGS= --vcd=TLB.vcd
...
elab : force
	$(GHDL) -c $(GHDLFLAGS) -e tlbtestbench

# Run target
run : force
	$(GHDL) -c $(GHDLFLAGS) -r tlbtestbench $(GHDLRUNFLAGS)
...
init: force
	...
	$(GHDL) -a $(GHDLFLAGS) TLBTestbench.vhdl
	$(GHDL) -a $(GHDLFLAGS) TLB.vhdl
